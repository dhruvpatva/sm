...
if ($bydirect) {
        ...
        if (!empty($_GET["search"])) { 
            $sqlTotal = "SELECT * FROM `post_types` WHERE (`name` LIKE '%" . $_GET["search"] . "%')";
            $sql = "SELECT * FROM `post_types` WHERE (`name` LIKE '%" . $_GET["search"] . "%') LIMIT $start_from, $num_rec_per_page";
        } else {
            $sqlTotal = "SELECT * FROM `post_types` ";
            $sql = "SELECT * FROM `post_types` LIMIT $start_from, $num_rec_per_page";
        }
